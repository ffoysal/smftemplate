...
<head>
    ...
    <title>Sabrian Memorial Foundation</title>
    <link rel="shortcut icon" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/images/smf_icon.png" type="image/png"/>

    <!-- Bootstrap Core CSS -->
    <link href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/heroic-features.css" rel="stylesheet">
...
<body>
    ...
    <div class="container">
        <div class="header">
            <!--div class="row">
                <div class="col-md-7">
                    <img src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/images/smflogo.png" class="img-circle">
                    <span class="logo-title"><h1>Sabrina Memorial Foundation</h1></span>
                </div>
                <div class="col-md-5">
                    <blockquote>
                        <p>Success has nothing to do with what you gain in life or accomplish for yourself. It's what you do for others.</p>
                        <footer><cite title="Source Title">Danny Thomas</cite></footer>
                    </blockquote>
                </div>
            </div-->
            <div class="col-md-8 smf-social-button-position-general">
            ...
            <footer>
                <div class="row">
                    <div class="col-md-4 col-md-offset-5">
                        Copyright &copy; Sabrina Memorial Foundation 2015
                    </div>
                </div>
            </footer>
            </nav>
